...
### Aplicando os filtros globalmente (acrescentado na instalação via NuGet)
...
public class Startup
{
	public void Configuration(IAppBuilder app)
	{
		...
		// O início e o fim de todas as ações serão registrados como DEBUG no Logger  
		httpConfiguration.Filters.Add(new WebApiFilters4Log.Action4LogFilterAttribute("Logger", WebApiFilters4Log.LogLevel.DEBUG));
...
public class Action4LogController : ApiController
{
	...
	// [20160505 19:50:43.250] [7] DEBUG - {"ContextId":"ba2dd75c-f35f-44c8-a3ef-b79a009f39c3","MachineName":"F2ASRV","Controller":"Action4Log","Action":"LogInfoWithHttpGet_Success","Method":"GET"} - Starting Action
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:50:43.379] [10] DEBUG - {"ContextId":"4e067583-41d2-47c8-beae-9b191fe8a7cb","MachineName":"F2ASRV","Controller":"Action4Log","Action":"LogInfoWithHttpGet_Fail","Method":"GET"} - Starting Action
...
public class Action4LogController : ApiController
{
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:50:40.031] [7] INFO - {"ContextId":"3430fb9c-20cf-4af8-baf4-5367c36a85fb","MachineName":"F2ASRV","Controller":"Action4Log","Action":"LogInfoWithHttpGet_Success","Method":"GET"} - Starting Action
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:50:43.379] [10] WARN - {"ContextId":"898a89d7-d01-4956-8c84-15f659460b34","MachineName":"F2ASRV","Controller":"Action4Log","Action":"LogInfoWithHttpGet_Fail","Method":"GET"} - Starting Action
...
public class Arguments4LogController : ApiController
{
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:51:40.252] [8] DEBUG - {"MachineName":"F2ASRV","Controller":"Arguments4Log","Action":"LogPrimitiveTypes","Method":"GET"} ARGS {"System.Int32 id":"6","System.Decimal value":"2.34","System.String text":"'testing'"}
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:52:04.837] [8] DEBUG - {"MachineName":"F2ASRV","Controller":"Arguments4Log","Action":"LogComplexTypes","Method":"POST"} ARGS {"WebApiFilters4Log.WebApiTest.Models.ClientModel client":"{'Id':'711192f5-a832-47e6-82cf-d2dda129f406','Name':'Jose Fulano','Years':35,'Emails':['joseFulano@teste.com','joseFulano2@gmail.com'],'Orders':[{'Date':'2016-02-25T11:27:05','Closed':true,'Items':[{'Product':'Arroz','Amount':2,'Value':13.23},{'Product':'Feijao','Amount':4,'Value':8.74}]}]}"}
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:52:19.382] [9] WARN - {"MachineName":"F2ASRV","Controller":"Arguments4Log","Action":"LogInformedComplexTypes","Method":"PUT"} ARGS {"System.Int32 id":"8","WebApiFilters4Log.WebApiTest.Models.ClientModel client":"{'Id':'711192f5-a832-47e6-82cf-d2dda129f406','Name':'Jose Fulano','Years':35,'Emails':['joseFulano@teste.com','joseFulano2@gmail.com'],'Orders':[{'Date':'2016-02-25T11:27:05','Closed':true,'Items':[{'Product':'Arroz','Amount':2,'Value':13.23},{'Product':'Feijao','Amount':4,'Value':8.74}]}]}"}
}
```
...
public class Arguments4LogController : ApiController
{
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:52.456] [10] DEBUG - {"MachineName":"F2ASRV","Controller":"Arguments4Log","Action":"LogPrimitiveTypes","Method":"GET"} ARGS {"System.Int32 id":"6","System.Decimal value":"2.34","System.String text":"'testing'"}
	...
	// Resultado obtido utilizando o PatternLayout do log4net "[%date{yyyyMMdd HH:mm:ss.fff}] [%thread] %level - %message%newline":
	// [20160505 19:52.551] [9] WARN - {"MachineName":"F2ASRV","Controller":"Arguments4Log","Action":"LogInformedComplexTypes","Method":"PUT"} ARGS {"WebApiFilters4Log.WebApiTest.Models.ClientModel client":"{'Id':'711192f5-a832-47e6-82cf-d2dda129f406','Name':'Jose Fulano','Years':35,'Emails':['joseFulano@teste.com','joseFulano2@gmail.com'],'Orders':[{'Date':'2016-02-25T11:27:05','Closed':true,'Items':[{'Product':'Arroz','Amount':2,'Value':13.23},{'Product':'Feijao','Amount':4,'Value':8.74}]}]}"}
}
```
...
public class Exception4LogController : ApiController
{
	...
	//	"Message": "testando log...",
	//	"ErrorCode": 500,
	//	"ErrorId": "a49eb6bc-b4db-442f-bb4b-c0b908f7437f",
	...
	//  "Message": "Ocorreu um erro inesperado executando Exception4Log.LogDetailedException!",
	//  "ErrorCode": 500,
	//  "ErrorId": "695d05df-a092-44d8-a2c3-531ab605edbc",
	//  "DateTime": "05/05/2016 19:20:41.91305"
	//}
